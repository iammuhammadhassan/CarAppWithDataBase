...
class VortexCard extends StatefulWidget {
  final Car car;

  const VortexCard({super.key, required this.car});

  @override
  State<VortexCard> createState() => _VortexCardState();
}

class _VortexCardState extends State<VortexCard> {
